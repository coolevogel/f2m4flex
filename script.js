...
play2.addEventListener('click', () => { sayTheWord(textArray[1]); });
play3.addEventListener('click', () => { sayTheWord(textArray[2]); });
...
const textArray = ['Broodje Haring', 'Butter en eek', 'gebakken paling', 'Zeeduivel met Oosterse saus'];
